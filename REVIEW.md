...
[SUGGESTION] `docker-compose.yml` dan `docker-compose.webhook.yml` — tag image kini dipin ke versi `1.9.4` dengan override `BOT_IMAGE`, sehingga upgrade tetap memerlukan perubahan tag secara eksplisit — ubah `BOT_IMAGE` saat merilis versi baru.
